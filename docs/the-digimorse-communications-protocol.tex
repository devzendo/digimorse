...
A number in the range 0 to \emph{n} can be represented in $1+floor\left(\log_2\left(n\right)\right)$ bits. The longest duration of 1680ms could be expressed as a binary field of 11 bits, as could any value up to 2047. This \emph{naïve} approach to encoding could work\marginnote{Do The Simplest Thing That Could Possibly Work}, but would be inefficient, as will be shown next.
